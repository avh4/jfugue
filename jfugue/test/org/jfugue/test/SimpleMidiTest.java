...
/** 
 * This class is a reference point for my sanity. 
 * It is a simple MIDI player that writes data directly to the channels.
 * The StreamingMidiEventManager should work in the same way.  
 */
