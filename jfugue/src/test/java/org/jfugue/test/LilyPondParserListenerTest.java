...
public class LilyPondParserListenerTest {
	...
	private MusicStringParser parser = null;
	...
	public void parallelNotes4() {
		doTest("C4h+C5q_B4i_E4i_G4i_B4i",
				"<< { c2 } \\\\ { c'4 b8 e,8 g8 b8 } >>");
	}
	...
	@Test
	public void chords() {
		doTest("A4majq. A4majq. ", "<a' cis e>4. <a cis e>4. ");
	}
	...
	private void doTest(String jfugueStr, String lilyStr) {
		pattern.setMusicString(jfugueStr);
		parser.parse(pattern);
		Assert.assertEquals("\\new Staff { " + lilyStr + " } ",
				listener.getLyString());
	}
	...
	public void parallelOctaveChange() {
		doTest("B4i+D#5i+F#5i Ri D4q E4q", "<b' ees fis>8 r8 d,4 e4");
	}

	@Test
	public void threeStaves() {
		doTestMultipleStaves(
				"V0 I16 A4q V1 I20 B4q V2 I24 C4q",
	...
	public void twoStavesParallel() {
		doTestMultipleStaves(
				"V0 I16 A4q V1 I20 B4q+A4q V2 I24 C4q",
